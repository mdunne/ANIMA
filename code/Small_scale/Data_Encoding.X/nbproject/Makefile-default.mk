...
${OBJECTDIR}/Data_Encoding_Test.o: Data_Encoding_Test.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/Data_Encoding_Test.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"../118_Libraries/include" -MMD -MF "${OBJECTDIR}/Data_Encoding_Test.o.d" -o ${OBJECTDIR}/Data_Encoding_Test.o Data_Encoding_Test.c   
...
${OBJECTDIR}/Data_Encoding_Test.o: Data_Encoding_Test.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/Data_Encoding_Test.o.d 
	@${RM} ${OBJECTDIR}/Data_Encoding_Test.o 
	@${FIXDEPS} "${OBJECTDIR}/Data_Encoding_Test.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"../118_Libraries/include" -MMD -MF "${OBJECTDIR}/Data_Encoding_Test.o.d" -o ${OBJECTDIR}/Data_Encoding_Test.o Data_Encoding_Test.c   
