...
static volatile unsigned int * const LED_TRISCLR[] = {&TRISBCLR, &TRISBCLR, &TRISBCLR, &TRISBCLR,};

static volatile unsigned int * const LED_TRISSET[] = {&TRISBSET, &TRISBSET, &TRISBSET, &TRISBSET,};

static volatile unsigned int * const LED_LATCLR[] = {&LATBCLR, &LATBCLR, &LATBCLR, &LATBCLR,};

static volatile unsigned int * const LED_LATSET[] = {&LATBSET, &LATBSET, &LATBSET, &LATBSET,};

static volatile unsigned int * const LED_LATINV[] = {&LATBINV, &LATBINV, &LATBINV, &LATBINV,};

#ifdef JP_SPI_MASTER
static unsigned short int LED_bitsMap[] = {BIT_5, BIT_7, BIT_9, BIT_8,
